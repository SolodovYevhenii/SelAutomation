...
public class StoreCookieInfo {
	public static void main(String... args) {
		...
		driver.findElement(By.name("email")).sendKeys("evg.sldv@gmail.com");
		driver.findElement(By.name("pass")).sendKeys("59747_seo_fb");
		driver.findElement(By.id("u_0_r")).click();
		File f = new File("C:/Users/Евгений/Documents/Selenium/browser.data");
		try {
			f.delete();
			f.createNewFile();
